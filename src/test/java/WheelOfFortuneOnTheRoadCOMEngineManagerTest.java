...
public class WheelOfFortuneOnTheRoadCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(WheelOfFortuneOnTheRoadCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/WheelOfFortuneOnTheRoadIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/WheelOfFortuneOnTheRoadIW/InitOutcome.xml").getDocumentElement();
